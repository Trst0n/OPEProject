 ...
 */
class getCurriculumRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CurriculumRepository' shared autowired service.
     *
     * @return \App\Repository\CurriculumRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CurriculumRepository.php';

        return $container->privates['App\\Repository\\CurriculumRepository'] = new \App\Repository\CurriculumRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
