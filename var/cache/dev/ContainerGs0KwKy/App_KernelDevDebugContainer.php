...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getDoctrine_Orm_DefaultEntityListenerResolverService($container)
    {
        $container->services['doctrine.orm.default_entity_listener_resolver'] = $instance = new \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerEntityListenerResolver(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Event\\SponsorshipStatusUpdate' => ['privates', 'App\\Event\\SponsorshipStatusUpdate', 'getSponsorshipStatusUpdateService', true],
        ], [
            'App\\Event\\SponsorshipStatusUpdate' => '?',
        ]));

        $instance->registerService('App\\Event\\SponsorshipStatusUpdate', 'App\\Event\\SponsorshipStatusUpdate');
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Service\\RegisterEvents' => ['privates', 'App\\Service\\RegisterEvents', 'getRegisterEventsService', true],
    ...
    protected static function getStateMachine_SponsoringProcessService($container)
    {
        ...
        return $container->privates['state_machine.sponsoring_process'] = new \Symfony\Component\Workflow\StateMachine(new \Symfony\Component\Workflow\Definition(['initialized', 'sponsor_approved', 'student_approved', 'student_rejected', 'sponsor_rejected', 'approved', 'sponsorship', 'ended'], [new \Symfony\Component\Workflow\Transition('st_validate', 'initialized', 'student_approved'), new \Symfony\Component\Workflow\Transition('sp_validate', 'initialized', 'sponsor_approved'), new \Symfony\Component\Workflow\Transition('st_refuse', 'initialized', 'student_rejected'), new \Symfony\Component\Workflow\Transition('sp_refuse', 'initialized', 'sponsor_rejected'), new \Symfony\Component\Workflow\Transition('sp_approve', 'student_approved', 'approved'), new \Symfony\Component\Workflow\Transition('st_approve', 'sponsor_approved', 'approved'), new \Symfony\Component\Workflow\Transition('st_reject', 'sponsor_approved', 'student_rejected'), new \Symfony\Component\Workflow\Transition('sp_reject', 'student_approved', 'sponsor_rejected'), new \Symfony\Component\Workflow\Transition('to_conclude', 'approved', 'sponsorship'), new \Symfony\Component\Workflow\Transition('to_end', 'sponsorship', 'ended')], ['initialized'], new \Symfony\Component\Workflow\Metadata\InMemoryMetadataStore([], [], new \SplObjectStorage())), new \Symfony\Component\Workflow\MarkingStore\MethodMarkingStore(true, 'state'), $a, 'sponsoring_process', NULL);
    }
