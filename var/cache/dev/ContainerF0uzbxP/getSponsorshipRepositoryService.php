...
class getSponsorshipRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SponsorshipRepository.php';

        return $container->privates['App\\Repository\\SponsorshipRepository'] = new \App\Repository\SponsorshipRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
