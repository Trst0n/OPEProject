...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getStateMachine_SponsoringProcessService($container)
    {
        ...
        return $container->privates['state_machine.sponsoring_process'] = new \Symfony\Component\Workflow\StateMachine(new \Symfony\Component\Workflow\Definition(['initialized', 'semiValidated_match', 'approved', 'sponsorship', 'ended', 'rejected'], [new \Symfony\Component\Workflow\Transition('to_validate', 'initialized', 'semiValidated_match'), new \Symfony\Component\Workflow\Transition('to_refuse', 'initialized', 'rejected'), new \Symfony\Component\Workflow\Transition('to_approve', 'semiValidated_match', 'approved'), new \Symfony\Component\Workflow\Transition('to_reject', 'semiValidated_match', 'rejected'), new \Symfony\Component\Workflow\Transition('to_conclude', 'approved', 'sponsorship'), new \Symfony\Component\Workflow\Transition('to_end', 'sponsorship', 'ended')], ['initialized'], new \Symfony\Component\Workflow\Metadata\InMemoryMetadataStore([], [], new \SplObjectStorage())), new \Symfony\Component\Workflow\MarkingStore\MethodMarkingStore(true, 'state'), $a, 'sponsoring_process', NULL);
    }
