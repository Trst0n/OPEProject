...
class getApiControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\ApiController'] = $instance = new \App\Controller\ApiController(($container->privates['App\\Service\\Algorithm'] ?? $container->load('getAlgorithmService')), new \App\Service\RegistrationService(($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), ($container->privates['App\\Service\\FindEntity'] ?? $container->load('getFindEntityService')), ($container->privates['debug.validator'] ?? self::getDebug_ValidatorService($container))), ($container->privates['App\\Service\\Mailing'] ?? $container->load('getMailingService')), ($container->services['monolog.logger.history'] ?? $container->load('getMonolog_Logger_HistoryService')));
