 ...
 */
final class Version20230702185539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sponsorship (id INT AUTO_INCREMENT NOT NULL, sponsor_request_id INT NOT NULL, sponsor_proposal_id INT NOT NULL, administrator_id INT DEFAULT NULL, wishes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', state VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updates_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', score INT DEFAULT NULL, score_indicators LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_C0F10CD45E98090 (sponsor_request_id), INDEX IDX_C0F10CD4A28D7343 (sponsor_proposal_id), INDEX IDX_C0F10CD44B09E92C (administrator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
