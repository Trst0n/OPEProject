 ...
 */
final class Version20230621100053 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `lead` (id INT AUTO_INCREMENT NOT NULL, person_id INT DEFAULT NULL, city_id INT NOT NULL, curriculum_id INT NOT NULL, languages LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', wishes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', state VARCHAR(255) NOT NULL, discr VARCHAR(255) NOT NULL, INDEX IDX_289161CB217BBB47 (person_id), INDEX IDX_289161CB8BAC62AF (city_id), INDEX IDX_289161CB5AEA4428 (curriculum_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE person (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, phonenumber VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, birthdate DATE NOT NULL, civility VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', discr VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sponsorship (id INT AUTO_INCREMENT NOT NULL, sponsor_request_id INT NOT NULL, sponsor_proposal_id INT NOT NULL, wishes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', state VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_C0F10CD45E98090 (sponsor_request_id), INDEX IDX_C0F10CD4A28D7343 (sponsor_proposal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
